 ...
 */
public class DeliveriesPresenterTest {

    @Mock
    DeliveriesContract.View view;
    @Mock
    ...
    @Mock
    Location location;
    private DeliveriesPresenter<DeliveriesContract.View> presenter;

    @Before
    public void initMocks() {
        MockitoAnnotations.initMocks(this);
        presenter = new DeliveriesPresenter<>(businessRepositoryImpl);
